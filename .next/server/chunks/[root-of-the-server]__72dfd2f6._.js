...
"[project]/lib/stormglass.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function getSurfForecast(lat, lng) {
    ...
    const response = await fetch(`${STORMGLASS_API_URL}/weather/point?lat=${lat}&lng=${lng}&params=${params}`, {
        headers: {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$stormglass$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/stormglass.ts [app-route] (ecmascript)");
...
async function GET(request) {
    try {
        ...
        const forecast = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$stormglass$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getSurfForecast"])(lat, lng);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(forecast);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__72dfd2f6._.js.map